...
GoogleUrl = (function() {
  function GoogleUrl(sourceIdentifier) {
    ...
    this.jsonCellsUrl = "http://spreadsheets.google.com/feeds/cells/" + this.key + "/oirphpj/public/basic?alt=json-in-script";
    this.jsonListUrl = "http://spreadsheets.google.com/feeds/list/" + this.key + "/oirphpj/public/basic?alt=json-in-script";
